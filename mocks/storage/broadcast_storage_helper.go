...
func (_m *BroadcastStorageHelper) FindTransaction(_a0 context.Context, _a1 *types.TransactionIdentifier, _a2 storage.DatabaseTransaction) (*types.BlockIdentifier, *types.Transaction, error) {
	ret := _m.Called(_a0, _a1, _a2)

	var r0 *types.BlockIdentifier
	if rf, ok := ret.Get(0).(func(context.Context, *types.TransactionIdentifier, storage.DatabaseTransaction) *types.BlockIdentifier); ok {
		r0 = rf(_a0, _a1, _a2)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*types.BlockIdentifier)
	...
	if rf, ok := ret.Get(1).(func(context.Context, *types.TransactionIdentifier, storage.DatabaseTransaction) *types.Transaction); ok {
		r1 = rf(_a0, _a1, _a2)
	} else {
		if ret.Get(1) != nil {
	...
	var r2 error
	if rf, ok := ret.Get(2).(func(context.Context, *types.TransactionIdentifier, storage.DatabaseTransaction) error); ok {
		r2 = rf(_a0, _a1, _a2)
	} else {
		r2 = ret.Error(2)
	}
