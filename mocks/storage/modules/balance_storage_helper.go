...
// AccountSeqNum provides a mock function with given fields: ctx, account, currency, block
func (_m *BalanceStorageHelper) AccountSeqNum(ctx context.Context, account *types.AccountIdentifier, currency *types.Currency, block *types.BlockIdentifier) (int32, error) {
	ret := _m.Called(ctx, account, currency, block)

	var r0 int32
	if rf, ok := ret.Get(0).(func(context.Context, *types.AccountIdentifier, *types.Currency, *types.BlockIdentifier) int32); ok {
		r0 = rf(ctx, account, currency, block)
	} else {
		r0 = ret.Get(0).(int32)
	}
...
// SequenceNumSupport provides a mock function with given fields:
func (_m *BalanceStorageHelper) SequenceNumSupport() *types.SequenceNumSupport {
	ret := _m.Called()

	var r0 *types.SequenceNumSupport
	if rf, ok := ret.Get(0).(func() *types.SequenceNumSupport); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*types.SequenceNumSupport)
		}
	}
