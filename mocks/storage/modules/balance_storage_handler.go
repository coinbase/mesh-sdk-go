...
func (_m *BalanceStorageHandler) BlockAdded(ctx context.Context, block *types.Block, changes []*parser.BalanceSeqChange) error {
	ret := _m.Called(ctx, block, changes)

	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, *types.Block, []*parser.BalanceSeqChange) error); ok {
...
func (_m *BalanceStorageHandler) BlockRemoved(ctx context.Context, block *types.Block, changes []*parser.BalanceSeqChange) error {
	ret := _m.Called(ctx, block, changes)
