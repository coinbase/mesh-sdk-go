...
func (_m *WorkerHelper) AllAddresses(ctx context.Context) ([]string, error) {
	ret := _m.Called(ctx)
...
func (_m *WorkerHelper) Balance(_a0 context.Context, _a1 *types.AccountIdentifier) ([]*types.Amount, error) {
	ret := _m.Called(_a0, _a1)

	var r0 []*types.Amount
	if rf, ok := ret.Get(0).(func(context.Context, *types.AccountIdentifier) []*types.Amount); ok {
		r0 = rf(_a0, _a1)
	} else {
		if ret.Get(0) != nil {
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(context.Context, *types.AccountIdentifier) error); ok {
		r1 = rf(_a0, _a1)
	} else {
		r1 = ret.Error(1)
	}
...
// Coins provides a mock function with given fields: _a0, _a1
func (_m *WorkerHelper) Coins(_a0 context.Context, _a1 *types.AccountIdentifier) ([]*types.Coin, error) {
	ret := _m.Called(_a0, _a1)
...
func (_m *WorkerHelper) LockedAddresses(_a0 context.Context) ([]string, error) {
	ret := _m.Called(_a0)
