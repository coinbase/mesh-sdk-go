...
type Version struct {
	...
	RosettaVersion string `json:"rosetta_version"              yaml:"rosetta_version"`
	...
	MiddlewareVersion *string `json:"middleware_version,omitempty" yaml:"middleware_version,omitempty"`
