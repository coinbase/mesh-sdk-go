...
// * schnorr_poseidon: `r (32-bytes) || s (32-bytes)` - `64 bytes`  (schnorr signature with Poseidon hash function implemented by O(1) Labs where both `r` and `s` are scalars encoded as `32-bytes` values
